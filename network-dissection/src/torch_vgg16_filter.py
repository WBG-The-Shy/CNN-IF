...
class VGG16_filter(nn.Module):
    # def __init__(self):
    def __init__(self,fmask5, fmask6, fmask7):
        super(VGG16_filter, self).__init__()
    ...
    #  f_2, f_3]
class vgg_fmaps_filter(nn.Module):
    def __init__(self, mean, std,fmask5, fmask6, fmask7):
    # def __init__(self, mean, std):
        super(vgg_fmaps_filter, self).__init__()
        ...
        self.extractor = VGG16_filter(fmask5, fmask6, fmask7)
